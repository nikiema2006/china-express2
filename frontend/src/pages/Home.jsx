    ...
    <div data-testid="home-page">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 md:pt-16">
        <div className="flex items-end justify-between mb-5">
          ...
          <Link to="/catalogue" className="hidden md:inline-flex items-center gap-1.5 text-sm text-[#5C5854] hover:text-[#B8941E]">
        ...
        <div className="flex gap-2.5 overflow-x-auto scrollbar-hide -mx-4 px-4 pb-1 md:hidden">
          {CATEGORIES.filter((c) => c.id !== "all").map((cat) => {
            ...
            return (
              ...
              >
                <div className="w-[60px] h-[60px] rounded-2xl bg-white border border-[#1A1515]/8 shadow-soft flex items-center justify-center group-hover:border-[#B8941E]/40 transition-all">
